...
import type { MpqDecompressor } from "./mpq.js";

let readyPromise: Promise<void> | null = null;

/** 确保 wasm 已就绪（浏览器/Worker 路径）。 */
export function initComputeWasm(): Promise<void> {
  if (!readyPromise) {
 ...
 */
export function markComputeWasmReady(): void {
  readyPromise = Promise.resolve();
}

/** 装配一个基于 wasm 的 bzip2 解压后端。 */
export function createWasmDecompressor(): MpqDecompressor {
  return {
    async bzip2(data: Uint8Array): Promise<Uint8Array> {
